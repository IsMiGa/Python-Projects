...
""" THIS SCRIPT TAKES THE VALUES OUT OF THE ETF DATABASE AND APPENDS THEM
TO LISTS, AFTER THE LISTS ARE COMPLETE THEY ARE PASSED AS ARGUMENTS TO
THE RENDER_TEMPLATE FUNCTION TO BE SHOWN IN A TABLE"""
